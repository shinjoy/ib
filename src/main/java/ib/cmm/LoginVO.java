 ...
 *  
 */
public class LoginVO extends WorkVO{
	...
	private String sabun;		//사번 추가 20150706
	
	private String analMaster;	//분석의견 등록 특수 권한자 'Y'
	private String infoLevel;	//정보공개등급
	private String mnaLevel;	//정보공개등급(M&A)
	private String reviewLevel;	//투심레벨
	private String preStaff;	//정사원전 상태 여부
	
	private String phn1;		//휴대폰
	
	
	private String deptNm;		///부서 -> ERP_PER_DEPT

	private String division; 	//division ->ib_staff
	...
	private String emailPasswd;	//email 패스워드
	
	private String dealSms;		//sms수신여부
	private String noReadAllYn;	//읽지않은글 전체보기 여부
	...
	public String getPreStaff() {
		return preStaff;
	}
	public void setPreStaff(String preStaff) {
		this.preStaff = preStaff;
	}
	...
	public String getNoReadAllYn() {
		return noReadAllYn;
	}
	public void setNoReadAllYn(String noReadAllYn) {
		this.noReadAllYn = noReadAllYn;
	}
