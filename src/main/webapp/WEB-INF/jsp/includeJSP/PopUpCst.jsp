	...
	<div class="_popUpWidth">
		<table class="pop_tb_basic">
			...
			<c:forEach var="cst" items="${cstList}" varStatus="status">
				<tr name="result_searched${status.count}" class="link">
					<td onclick="End('${cst.sNb}','${cst.cstNm }','${cst.cpnId}','${cst.cpnNm }','${cst.position }','${cst.cpnSnb }');" class="cent" style="text-align:left;padding: 5px 0 5px 5px!important;"><b>${cst.cstNm }</b></td>
					<td onclick="End('${cst.sNb}','${cst.cstNm }','${cst.cpnId}','${cst.cpnNm }','${cst.position }','${cst.cpnSnb }');" class="cent">${cst.cpnNm }</td>
					<td onclick="End('${cst.sNb}','${cst.cstNm }','${cst.cpnId}','${cst.cpnNm }','${cst.position }','${cst.cpnSnb }');" class="cent">${cst.position }</td>
					<td onclick="editPerson('${cst.sNb}');" class="cent"><img src="<c:url value='/images/sp/btn_modify.gif' />" width="13" height="13" /></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
