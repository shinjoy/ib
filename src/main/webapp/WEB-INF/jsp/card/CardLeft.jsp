...
//});
 /*function sortUser(th,staffName,staffId){
	...
	//alert(parent.mainFrame.choice_month.value)
	$("#s_mon").val($('#choice_month',parent.frames['mainFrame'].document).val());
	$("#s_year").val($('#choice_year',parent.frames['mainFrame'].document).val());
...
<body>
	<form id="staffName" name="cName" method="post" action="<c:url value='/card/index.do' />">
	...
	<section>
		...
		<ul class="dual">
			...
			<li>
				<a onclick="fnObj.sortUser(this,'','');">전체</a>
			</li>
			<li id="userListDivSynergy">
				
			</li>
			<li id="userListDivFides">
