...
<html lang="ko">
	...
	<div class="windowbox">
		...
		<div class="gtabZone mgb10" id="tabArea">
			<ul>
				<li class="on"><a href="${pageContext.request.contextPath}/iosGuide.do">IOS 설치안내</a></li>
				<li><a href="${pageContext.request.contextPath}/andGuide.do">Android 설치안내</a></li>
				<li><a href="${pageContext.request.contextPath}/mvGuide.do">사용안내(동영상)</a></li>
			</ul>
		</div>
		<div class="ios_titleZone">
			<span class="btn_close"><img src="${pageContext.request.contextPath}/images_m/land/guide/btn_closed.gif" alt=""></span>
		</div>
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><img src="${pageContext.request.contextPath}/images_m/land/guide/ios_01.png" alt=""></div>
				<div class="swiper-slide"><img src="${pageContext.request.contextPath}/images_m/land/guide/ios_02.png" alt=""></div>
				<div class="swiper-slide"><img src="${pageContext.request.contextPath}/images_m/land/guide/ios_03.png" alt=""></div>
				<div class="swiper-slide"><img src="${pageContext.request.contextPath}/images_m/land/guide/ios_04.png" alt=""></div>
				<div class="swiper-slide"><img src="${pageContext.request.contextPath}/images_m/land/guide/ios_05.png" alt=""></div>
			</div>
