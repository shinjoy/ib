...
function dealInfo(num, flag, nm, snb){
	...
	if(flag=='rcmdComment'){
		...
		sUrl+='?sNb='+snb+'&choice_year='+tmDate[0]+'&choice_monthS='+tmDate[1];
	}
...
function alertLogin(){
	...
	$.blockUI({
		message : "<b>SESSION OUT!!</b><br><iframe src='/IBsystem/login/ibLoginUsr.do' width='100%' height='300' border='0' style='border:hidden'></iframe><br><br><input type='button' value='닫기' onclick='removeModalNReload();' />",		
		css : {
			border : '1px solid #0000ff'
		}
	});
