 ...
 *            callback function
 */
function commonAjaxSubmit(pgType, $frm, callbackFn, isAsync, beforeFn, completeFn) {
	// async or sync
	var async = true; // default : async(비동기)
	if (isAsync != null) {
		async = isAsync;
 ...
 * 
 */
function commonAjaxTohtml( url, params, callback){
