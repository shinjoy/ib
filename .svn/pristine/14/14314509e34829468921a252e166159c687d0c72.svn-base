...
public class WorkVO  extends ComDefaultVO{
	...
	public final String ccdOffCd 		= "00002";
	public final String ccdPrgressCd	= "00004";
	public final String ccdCateCd 		= "00005";
	public final String ccdTabCd 		= "00021";
	public final String ccdMidOffCd 	= "00011";
	public final String ccdFamily 		= "00012";
	public final String ccdNWstaff 		= "00013";
	public final String ccdKeyPoint 	= "00018";
	...
	private String upDt    = "";
	private String tmDt    = "";
	private String offerTmDt = "";
	
	private String oriTmDt = "";
	...
	private String srchYear = "";		//분석의견 검색년도	20161205
	private String infoRgDt = "";		//ib_offer_info.rg_dt
	
	private String choice_year = "";
	private String choice_yearS = "";
	private String choice_month = "";
	private String choice_monthS = "";
	private String choice_day = "";
	private String choice_dayS = "";
...
//	memo
	...
	private String firSttsCd = "";
	private String comment = "";
	private String importance = "";
	private String oldcomment = "";
	private String memoSndName = "";
	private String memoSndSabun = "";		//sabun 추가 
	private String day = "";
	private String dayF = "";
...
// net
	...
	private String cstCpnStts;		//상장 비상장 회사 체크 위해 ... 'Q' or 'A' : 상장,  그외 : 비상장	(고객의) 
	
	private String deptId;			//부서 id (erp.erp_per_dept  deptSeq)
	private String deptNm;			//부서 명 (erp.erp_per_dept  deptNm)
	private String deptMngr;		//부서장 사번
	private String memoDeptId;	//메모 대상자의 부서장 사번
	
	private String schePublicFlag;	//일정 비공개 여부
	
	private String grpMemOne;		//메모 수신자 1명 이름(대표1명)
	private String grpMemCnt;		//메모 수신자명수
	
	private String selectUser;
	private String toMain;			//메인화면에서 보여지는지
	
	private String rgUserPhn;		//딜 등록자 폰번호
	
	private String dealIngInfoYn;	//딜 진행중인 건과 관련있는 정보인지 여부
	
	private String analUserFirst;	//첫 지정 분석자
	private String analUserCount;	//분석자 숫자
	private String analEachCount;	//분석중 분석자종류수
	
	private String dealSms;			//딜 상태변경 SMS 수신 여부
	private String rgStaffPhn1;		//등록자 전화번호
	
	private String staffNmForSms = "";	//문자수신대상자명
	private String pastYn;			//과거정보 여부
	private String preStaffCd;		//직원직전 코드
	private String srtCd;			//IB_STAFF.SRT_CD
	
	private String memoType;		//업무보고(메모) 유형
	private String memoTypeNm;		//업무보고(메모) 유형명
	private String alsoDailyWork;	//업무보고(메모) 유형이 '요청' 일때 업무일지 체크여부 'Y' or 'N'
	private String commentFirstNewLineIndex;	//업무보고(메모) 내용중 첫번째 new line character index
	
	private String memoLong;		//업무보고
	
	private String categoryType;	//smslog.category_type	데이터 유형 (0 : 기존, 1 : 업무일지)
	
	private String tmDtTime;		//시간부분
	private String readCnt;			//읽은 수
	private String lastReplyDt;		//업무보고 최종댓글 날짜
	private String replyCnt;		//댓글 수
	
	private String upId;			//수정자
	
	private String sabunForName ="";	//사번검색 등록
	
	private String hqId="";			//회사코드명
	
	private String userStatus;		//사용자 상태정보
	
	//모바일 신규 검색 조건 (딜)
	private String allDealYn ="";				//딜 전체를 볼 권한이 있는지 
	private String [] searchUserArr;			//아이디 배열
	private String dealSearchStatus ="";		//mna 이외 딜 상태값
	private String dealMNASearchStatus ="";		//mna 딜 상태값
	private String dealSearchStartDate ="";		//딜 검색 시작 기간
	private String dealSearchEndDate ="";		//딜 검색 시작 기간
	private String dealAnalStartPrice ="";		//투자 심의 점수 시작값
	private String dealAnalEndPrice ="";		//투자 심의 점수 끝
	private String rcmdEdit ="";				//추천인 변경 옵션
	
	
	
	
	public String getRcmdEdit() {
		return rcmdEdit;
	}
	public void setRcmdEdit(String rcmdEdit) {
		this.rcmdEdit = rcmdEdit;
	}
	public String getAllDealYn() {
		return allDealYn;
	}
	public void setAllDealYn(String allDealYn) {
		this.allDealYn = allDealYn;
	}
	public String getDealAnalStartPrice() {
		return dealAnalStartPrice;
	}
	public void setDealAnalStartPrice(String dealAnalStartPrice) {
		this.dealAnalStartPrice = dealAnalStartPrice;
	}
	public String getDealAnalEndPrice() {
		return dealAnalEndPrice;
	}
	public void setDealAnalEndPrice(String dealAnalEndPrice) {
		this.dealAnalEndPrice = dealAnalEndPrice;
	}
	public String getDealSearchStartDate() {
		return dealSearchStartDate;
	}
	public void setDealSearchStartDate(String dealSearchStartDate) {
		this.dealSearchStartDate = dealSearchStartDate;
	}
	public String getDealSearchEndDate() {
		return dealSearchEndDate;
	}
	public void setDealSearchEndDate(String dealSearchEndDate) {
		this.dealSearchEndDate = dealSearchEndDate;
	}
	public String getDealSearchStatus() {
		return dealSearchStatus;
	}
	public void setDealSearchStatus(String dealSearchStatus) {
		this.dealSearchStatus = dealSearchStatus;
	}
	public String getDealMNASearchStatus() {
		return dealMNASearchStatus;
	}
	public void setDealMNASearchStatus(String dealMNASearchStatus) {
		this.dealMNASearchStatus = dealMNASearchStatus;
	}
	public String[] getSearchUserArr() {
		return searchUserArr;
	}
	public void setSearchUserArr(String[] searchUserArr) {
		this.searchUserArr = searchUserArr;
	}
	public String getSabunForName() {
		return sabunForName;
	}
	public void setSabunForName(String sabunForName) {
		this.sabunForName = sabunForName;
	}
	public String getFirSttsCd() {
		return firSttsCd;
	}
	public void setFirSttsCd(String firSttsCd) {
		this.firSttsCd = firSttsCd;
	}
	public String getMemoSndSabun() {
		return memoSndSabun;
	}
	public void setMemoSndSabun(String memoSndSabun) {
		this.memoSndSabun = memoSndSabun;
	}

	public String getAnalUserFirst() {
		return analUserFirst;
	}
	public void setAnalUserFirst(String analUserFirst) {
		this.analUserFirst = analUserFirst;
	}
	public String getAnalUserCount() {
		return analUserCount;
	}
	public void setAnalUserCount(String analUserCount) {
		this.analUserCount = analUserCount;
	}
	...
	public String getExpStartPrice() {
		return expStartPrice;
	}
	public void setExpStartPrice(String expStartPrice) {
		this.expStartPrice = expStartPrice;
	}
...
/*	public void setRgId(String rgId) {
	...
	/**
	 * @param sMSToNum the sMSToNum to set
	 */
	public void setSMSToNum(String sMSToNum) {
		SMSToNum = sMSToNum;
	}
	/**
	 * @return the sMSFromNum
	 */
	public String getSMSFromNum() {
		return SMSFromNum;
	}
	/**
	 * @param sMSFromNum the sMSFromNum to set
	 */
	public void setSMSFromNum(String sMSFromNum) {
		SMSFromNum = sMSFromNum;
	}
	/**
	...
	/**
	 * @return the cDfinancing
	 */
	public String getCDfinancing() {
		return CDfinancing;
	}
	/**
	 * @param cDfinancing the cDfinancing to set
	 */
	public void setCDfinancing(String cDfinancing) {
		CDfinancing = cDfinancing;
	}
	/**
	 * @return the cDmanagement
	 */
	public String getCDmanagement() {
		return CDmanagement;
	}
	/**
	 * @param cDmanagement the cDmanagement to set
	 */
	...
	/**
	 * @param cDshare the cDshare to set
	 */
	...
	/**
	 * @return the choice_day
	 */
	public String getChoice_day() {
		return choice_day;
	}
	/**
	 * @param choice_day the choice_day to set
	 */
	public void setChoice_day(String choice_day) {
		this.choice_day = choice_day;
	}
	/**
	 * @return the choice_dayS
	 */
	public String getChoice_dayS() {
		return choice_dayS;
	}
	/**
	 * @param choice_dayS the choice_dayS to set
	 */
	public void setChoice_dayS(String choice_dayS) {
		this.choice_dayS = choice_dayS;
	}
	/**
	 * @return the resource
	 */
	...
	/**
	 * @param cDaudit the cDaudit to set
	 */
	public void setCDaudit(String cDaudit) {
		CDaudit = cDaudit;
	}
	/**
	 * @return the cDinvestInte
	 */
	public String getCDinvestInte() {
		return CDinvestInte;
	}
	/**
	 * @param cDinvestInte the cDinvestInte to set
	 */
	public void setCDinvestInte(String cDinvestInte) {
		CDinvestInte = cDinvestInte;
	}
	/**
	...
	/**
	 * @return the choice_yearS
	 */
	public String getChoice_yearS() {
		return choice_yearS;
	}
	/**
	 * @param choice_yearS the choice_yearS to set
	 */
	public void setChoice_yearS(String choice_yearS) {
		this.choice_yearS = choice_yearS;
	}
	/**
	 * @return the mainYn
	 */
	...
	/**
	 * @param cDservey the cDservey to set
	 */
	...
	public String getGrpMemOne() {
		return grpMemOne;
	}
	public void setGrpMemOne(String grpMemOne) {
		this.grpMemOne = grpMemOne;
	}
	public String getGrpMemCnt() {
		return grpMemCnt;
	}
	public void setGrpMemCnt(String grpMemCnt) {
		this.grpMemCnt = grpMemCnt;
	}
	...
	public String getInfoRgDt() {
		return infoRgDt;
	}
	public void setInfoRgDt(String infoRgDt) {
		this.infoRgDt = infoRgDt;
	}
	...
	public String getOfferTmDt() {
		return offerTmDt;
	}
	public void setOfferTmDt(String offerTmDt) {
		this.offerTmDt = offerTmDt;
	}
	...
	public String getRgUserPhn() {
		return rgUserPhn;
	}
	public void setRgUserPhn(String rgUserPhn) {
		this.rgUserPhn = rgUserPhn;
	}
	public String getDealIngInfoYn() {
		return dealIngInfoYn;
	}
	public void setDealIngInfoYn(String dealIngInfoYn) {
		this.dealIngInfoYn = dealIngInfoYn;
	}
	public String getDealSms() {
		return dealSms;
	}
	public void setDealSms(String dealSms) {
		this.dealSms = dealSms;
	}
	...
	public String getAnalEachCount() {
		return analEachCount;
	}
	public void setAnalEachCount(String analEachCount) {
		this.analEachCount = analEachCount;
	}
	public String getStaffNmForSms() {
		return staffNmForSms;
	}
	public void setStaffNmForSms(String staffNmForSms) {
		this.staffNmForSms = staffNmForSms;
	}
	public String getPastYn() {
		return pastYn;
	}
	public void setPastYn(String pastYn) {
		this.pastYn = pastYn;
	}
	public String getPreStaffCd() {
		return preStaffCd;
	}
	public void setPreStaffCd(String preStaffCd) {
		this.preStaffCd = preStaffCd;
	}
	...
	public String getMemoTypeNm() {
		return memoTypeNm;
	}
	public void setMemoTypeNm(String memoTypeNm) {
		this.memoTypeNm = memoTypeNm;
	}
	public String getAlsoDailyWork() {
		return alsoDailyWork;
	}
	public void setAlsoDailyWork(String alsoDailyWork) {
		this.alsoDailyWork = alsoDailyWork;
	}
	...
	public String getCommentFirstNewLineIndex() {
		return commentFirstNewLineIndex;
	}
	public void setCommentFirstNewLineIndex(String commentFirstNewLineIndex) {
		this.commentFirstNewLineIndex = commentFirstNewLineIndex;
	}
	...
	public String getTmDtTime() {
		return tmDtTime;
	}
	public void setTmDtTime(String tmDtTime) {
		this.tmDtTime = tmDtTime;
	}
	...
	public String getOriTmDt() {
		return oriTmDt;
	}
	public void setOriTmDt(String oriTmDt) {
		this.oriTmDt = oriTmDt;
	}
	public String getLastReplyDt() {
		return lastReplyDt;
	}
	public void setLastReplyDt(String lastReplyDt) {
	...
	public String getCstCpnStts() {
		return cstCpnStts;
	}
	public void setCstCpnStts(String cstCpnStts) {
		this.cstCpnStts = cstCpnStts;
	}
