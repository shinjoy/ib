...
SGrid.prototype.setGridDataEmpty = function(){
	...
	if(this.emptyOfList){
		...
		gridBodyObject.html('<tr><td colspan=' + emtpyColspanCnt + ' align=center bgcolor="#EEEEEE">조회된 데이터가 없습니다.</td></tr><tr><td colspan=' + emtpyColspanCnt + '></td></tr>');	//그리드 데이터 초기화
	}else{
		//그리드 데이터 초기화( tr 삭제)
		gridBodyObject.html('');					//그리드 데이터 초기화
	}
...
SGrid.prototype.setGridBodyEmpty = function(){
	...
	gridBodyObject.html('<tr><td colspan=' + emtpyColspanCnt + ' style="text-align:center!important;" bgcolor="#EEEEEE">조회된 데이터가 없습니다.</td></tr><tr><td colspan=' + emtpyColspanCnt + '></td></tr>');	//그리드 데이터 초기화
...
//    },
    ...
    colGroup : [
        ...
        {key:"empTypeNm",	label:"직원형태", 		width:"65",		align:"center"},
        {key:"company", 	label:"소속회사", 		width:"120",	align:"center"},
        {key:"incharge", 	label:"직책", 			width:"65",		align:"left"},
        {key:"position", 	label:"직급", 			width:"65",		align:"center"},
