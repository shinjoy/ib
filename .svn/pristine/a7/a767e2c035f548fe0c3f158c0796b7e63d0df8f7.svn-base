...
public class NoticeVO extends WorkVO{
	...
	private List<Map> receiverList;		//인수자리스트
	private String wrtYn		 = "";	//워런트만기여부 20170830 ksm	
	private String investorId	 = "";	//인수자id 20170830 ksm	
	...
	public List<Map> getReceiverList() {
		return receiverList;
	}
	public void setReceiverList(List<Map> receiverList) {
