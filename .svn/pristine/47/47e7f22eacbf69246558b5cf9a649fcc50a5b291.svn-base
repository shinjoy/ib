			...
			<table class="t_skinR00" style="width:100%">
				<tbody>
					<tr>
						...
						<td class="cent bgRed nameD">${userLoginInfo.name }</td>
					...
					<tr>
						...
						<td class="cent">${self.proof}
							...
							<c:if test="${userLoginInfo.id == self.rgId}"><span class="btn s"><a onclick="popUp('${status.count}','files')">업로드</a></span></c:if>
							<span>
						...
						<td class="cent" style="width:45px;">
							<c:if test="${userLoginInfo.name==self.usrNm}">
