...
<body>
	<ul>
		<li class="title cent"><span class="imp">제한된 30MByte</span> 용량을 추가했습니다.</li>
		<li class="cent">파일용량을 줄여서 다시 업로드 시키시거나, </li>
		<li class="cent">개발자에게 문의해 주세요.</li>
	</ul>
