...
<input type="hidden" id="rgstId" value="<c:out value='${userLoginInfo.id}'/>">
<div id="fixedTop" class="fixed-top" style="z-index:99;">
	<header>
	...
	<div>
		...
		<thead>
			<tr>
				<th rowspan="4" class="bgYlw pd0" style="height:86px;">활동<br/>내용</th>
				<th rowspan="4" class="bgYlw pd0">업무</th>
				<th colspan="12" class="bgGrn">딜</th>
				<th colspan="8" class="bgPich">자금</th>
				<th colspan="2" class="bgSky pd0">추천</th>
				<th rowspan="4" class="bgSky pd0">딜<br/>분석</th>
				<th rowspan="4" class="bgSky pd0">탐방</th>
				<th rowspan="4" class="bgSky pd0">리포트</th>
				<th rowspan="4" class="bgSky pd0">제안서</th>
				<th colspan="4" class="bgYlw">정보등록</th>
				<th rowspan="4" class="bgYlw pd0">네트<br/>워크<br/>등록</th>
				<th rowspan="4" class="bgYlw pd0">외부인<br/>소개</th>
				<th colspan="4" class="bgYlw pd0">Idea</th>
				<!-- <th rowspan="4" class="bgYlw pd0">공동<br/>진행</th> -->
				<%-- <th class="bgYlw">합계</th> --%>
			</tr>
			<tr>
				<th colspan="6" class="bgGrn pd0">중개</th>
				<th colspan="6" class="bgGrn pd0">직접발굴</th>
				<th colspan="3" class="bgPich pd0">일임</th>
				<th colspan="2" class="bgPich pd0">펀드</th>
				<th colspan="2" class="bgPich pd0">재매각</th>
				<th rowspan="3" class="bgPich pd0">총<br/>규모</th>

				<th rowspan="3" class="bgSky pd0">종목<br/>추천</th>
				<th rowspan="3" class="bgSky pd0">추천<br/>의견</th>

				<th rowspan="3" class="bgYlw pd0">횟수</th>
				<th colspan="3" class="bgYlw pd0">중요도</th>
				
				<th rowspan="3" class="bgYlw pd0">건수</th>
				<th rowspan="3" class="bgYlw pd0">평점</th>
				<th colspan="2" class="bgYlw pd0">코멘트</th>
			</tr>
			<tr>
				<c:forEach begin="1" end="2">
				<th rowspan="2" class="bgGrn pd0">제안</th>
				<th colspan="2" class="bgGrn pd0">단독</th>
				<th colspan="2" class="bgGrn pd0">공동</th>
				<th rowspan="2" class="bgGrn pd0">총<br/>규모</th>
				</c:forEach>
				<th rowspan="2" class="bgPich pd0" title="ib시스템->일임->성사">쿼터</th>
				<th rowspan="2" class="bgPich pd0" title="고객시스템의 일임금액">단독<br/>성사</th>
				<th rowspan="2" class="bgPich pd0" title="고객시스템의 일임금액">공동<br/>성사</th>
				<th rowspan="2" class="bgPich pd0">단독<br/>성사</th>
...
<div id="fixedcross" class="fixed-top" style="z-index:999;float:left;width:94px;padding:50px 0 0 10px;">
	<table class="t_skinR00" style="">
	<colgroup>
		<col width="47">
		<col width="47">
	</colgroup>
	<thead>
		<tr>
			<th rowspan="4" class="bgYlw pd0" style="height:86px">활동<br/>내용</th>
			<th rowspan="4" class="bgYlw pd0" style="height:86px;border-top-right-radius:0;">업무</th>
		</tr>
	</thead>
	</table>
</div>
	<div id="nfixedMain" class="t_skin05" style="width:1709px/* 47px */;height:100%;padding-top:137px;border-left:0;border-bottom:0;display:inline-block;">
