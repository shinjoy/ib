...
<form id="modifyRec" name="modifyRec" action="<c:url value='/work/audit.do' />" method="post"><input type="hidden" name="sorting" id="sorting"><input type="hidden" name="page" id="page"></form>
			...
			<table class="t_skinR00" style="padding-top:5px;">
				<thead>
					<tr>
						...
						<th onclick="sortTable(1);" class="hand bgYlw companyName">회사명<br/>▼</th>
						<th onclick="sortTable(2);" class="hand bgYlw personName">입력자<br/>▼</th>
						<th class="bgYlw">이력/정보</th>
						<th class="bgYlw" style="width:75px">딜 경력<small>(건)</small></th>
					</tr>
			...
			<table class="t_skinR00">
				<tbody>
					...
					<input type="hidden" id="snb${financStatus.count}" value="${financ.sNb}"/>
						...
						<td class="cent" style="width:70px">${financ.tmpNum1}</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
